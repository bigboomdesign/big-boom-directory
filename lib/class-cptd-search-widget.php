...
class CPTD_search_widget extends WP_Widget{
	...
	function widget($args, $instance){
		...
		$view_all_link = ($instance['view_all_link']?$instance['view_all_link']:(CPTD_Options::$options['search_page']?get_permalink(CPTD_Options::$options['search_page']):""));
		...
		?>
			<form method="post" id="cptdir-search-form" action="<?php if(CPTD_Options::$options['search_page']) echo get_permalink(CPTD_Options::$options['search_page']); ?>">
				<?php
				# Category taxonomy
